 ...
 *
 * The mDNS hostname is `obsidianboard` — deliberately not renamed to follow the
 * board's new job, because paired apps and flashed boards already answer to it.
 * NOT the `tickerboard` of the fortune board this project forked from either:
 * that name is hardcoded in the other project's shipped app, and two devices
 * answering one discovery probe on the same LAN is a fault nobody can diagnose
 * from the phone side.
 */
#pragma once
