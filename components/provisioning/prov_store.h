// NVS-backed persistence for the provisioning config (Wi-Fi credentials + weather location).
#pragma once
...
// Persist `cfg` (SSID, password, weather location). Also erases the keys the
